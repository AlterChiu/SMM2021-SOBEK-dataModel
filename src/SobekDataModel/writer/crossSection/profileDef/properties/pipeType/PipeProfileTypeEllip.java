...
public class PipeProfileTypeEllip implements PipeProfileType {
	...
	public double getWidth() throws Exception {
		if (this.width == Global.doubleNull)
			throw new Exception("*ERROR* width PipeProfile-Ellipse wasn't initial yet");
		return width;
	}
	...
	public double getHeight() throws Exception {
		if (this.height == Global.doubleNull)
			throw new Exception("*ERROR* height PipeProfile-Ellipse wasn't initial yet");
		return height;
	}
	...
	public List<KeyValuePair<String, Double>> getKeyValues() throws Exception {
		...
		outList.add(new KeyValuePair<String, Double>("ew", this.getWidth()));
		outList.add(new KeyValuePair<String, Double>("eh", this.getHeight()));
